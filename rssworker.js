...
// Returns the trimmed text content of the first matching child element
function childText(el, tag) {
const found = el.querySelector(tag);
return found ? (found.textContent || “”).trim() : null;
}

// Parses an RSS <item> or Atom <entry> into a plain object
...
// Top-level RSS/Atom parser — returns a clean, flat object
